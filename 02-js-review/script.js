...
//can place the spread operator at the end of destructuring
...
//can add elemnt at the begining
//const newGenres = ["epic fantasy",...genres];
//adding and updating the properties in an object
const updatedBook = {
  ...book,
...
//template literals
const summary = `${title},a ${pages}-pages is a book was written by ${author} and published in ${getYear(
  publicationDate
)}`;
summary;
...
//short-ircuiting logical && and || operators
